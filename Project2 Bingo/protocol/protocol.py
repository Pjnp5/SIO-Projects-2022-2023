...
# class AskKeyMessage(Message):
    
#     def __init__(self, command : str, sender : int, receivers : list):
#         super().__init__(command, sender, receivers)

#     def __repr__(self):
#         return f'{{{super().__repr__()}}}'

#     def dic(self):
#         return {"command":super().getcommand(), "sender" : self.sender, "receivers" : self.receivers}
...
class BingoProto:
    ...
    def process_msg(cls, msg : dict):
        ...
        # elif command == "askKey":
        #     return cls.askKey(sender, receivers)
